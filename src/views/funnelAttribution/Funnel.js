                        ...
                        <Row className="row">
                            ...
                            <Col xl='7' lg='6' sm='12' className="d-flex flex-row p-1" style={{ minHeight: 350 }}>
                                ...
                                <div className="content-29A4F7 hide3 w-100 p-0 m-0 d-none data" style={{ height: 250 }} >
                                    <div className="d-none d-lg-block w-25 position-relative border-top-secondary" style={{ marginLeft: "-182px", top: 215, height: 0 }} />
                                    <div className="w-100">
                                        <div className="w-100 align-items-center flex-column">
                                ...
                                <div className="content-27CA75 hide4 w-100 d-none data" style={{ height: 250 }}>
                                    <div className="d-none d-lg-block w-25 position-relative border-top-success" style={{ marginLeft: "-182px", top: 300, height: 0 }} />
                                    <div className="w-100">
                                        <div className="w-100 align-items-center flex-column">
