        ...
        <>
            ...
            <div className='d-flex justify-content-end'>
                <form className="form-inline my-lg-0">
                    ...
                    <button className="mb-1 btn btn-warning" onClick={downloadHandle}>Download</button>
                </form>
            </div>
            ...
            <div className='d-flex justify-content-end'>
                <form className="form-inline my-lg-0">
                    {/* <input className="form-control" type="search" placeholder="Search" aria-label="Search" /> */}
                    {/* <button className="btn btn-outline-primary m-1" type="submit">Search</button> */}
                    <button className="mb-1 btn btn-secondary" onClick={downloadHandle}>Download</button>
                </form>
            </div>
            ...
            <div className='d-flex justify-content-end'>
                <form className="form-inline my-lg-0">
                    {/* <input className="form-control" type="search" placeholder="Search" aria-label="Search" /> */}
                    {/* <button className="btn btn-outline-primary m-1" type="submit">Search</button> */}
                    <button className="mb-1 btn btn-success" onClick={downloadHandle}>Download</button>
                </form>
            </div>
